...
export default function ProfileContent() {
  return (
    <Tabs defaultValue="personal" className="space-y-2 md:space-y-4">
      <TabsList className="grid w-full grid-cols-4">
        <TabsTrigger className="max-sm:text-xs max-sm:p-2" value="personal">
          Personal
        </TabsTrigger>
        <TabsTrigger className="max-sm:text-xs max-sm:p-2" value="account">
          Account
        </TabsTrigger>
        <TabsTrigger className="max-sm:text-xs max-sm:p-2" value="security">
          Security
        </TabsTrigger>
        <TabsTrigger
      ...
      <TabsContent value="personal" className="space-y-2 md:space-y-4">
        <Card>
          <CardHeader>
